...
export default {
  ...
  methods: {
    ...
    setAutoplay(itemIndex) {
      if(this.checkIfIsObject(itemIndex) && 
      Object.prototype.hasOwnProperty.call(this.items[itemIndex], "autoplay") &&
    ...
    setXPosition(index) {
      ...
      if(this.dir === 'rtl') {
        this.xSwipeWrapper = index*this.lightboxInnerWidth+rightMargin*index + rightMargin
        return
      }
      // set x position
