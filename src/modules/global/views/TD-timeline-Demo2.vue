<template>
  ...
  <div
    class="container td-generic-timeline-wrapper td-generic-timeline-wrapper--type2 td-listing-container"
  >
    <Listing
      loader
      :service="getData"
          ...
          data-aos-offset="0" data-aos-duration="1000">
            ...
            <div data-aos="fade-up" data-aos-delay="200">
              <div
                ...
                :class="[
                  index % 2 ? 'td-generic-timeline__row__card--reverse' : '',
                ]"
              >
                <div
                  class="col-md-6 col-12 td-generic-timeline__row__card__article"
                >
                  <h1>this is dummy title</h1>
                  <p>this is dummy description</p>
                </div>
                <div
                  class="col-md-6 col-12 td-generic-timeline__row__card__image"
                >
