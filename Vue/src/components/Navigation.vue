    ...
    <div class="navbar-container">
      ...
      <div class="navbar-collapse collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <router-link to="/genericFormValidations" class="nav-link"
              >Generic Form Validations</router-link
            >
          </li>
          ...
          <li class="nav-item">
            <router-link to="/genericCharts" class="nav-link"> Generic Charts</router-link>
          </li>
        </ul>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    const darkModeToggleBtn =
      document.getElementsByClassName("dark-mode-toggle");
