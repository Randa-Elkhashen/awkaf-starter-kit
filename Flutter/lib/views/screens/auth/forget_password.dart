...
import 'package:flutter_app/view_models/forget_password_model.dart';
                  ...
                  children: [
                    ...
                    ATextFormField(
                      ...
                      validator: (value) => Validator.isValidPassword(value)
                          ? null : "Password at least 6 characters or numbers",
                      onChange: (value){
                    ...
                    ATextFormField(
                      ...
                      validator: (value) => value == _model.password
                          ? null : "Confirm password and password not match",
                    ),
                    SizedBox(height: 32 ,),
                    SizedBox(
