    ...
    <div class="form-card">
        ...
        <div  class="form-card__form__fields">
            <div class="mb-2 form-floating td-field-group td-field-group--required">
                <input type="password" placeholder="New Password" autocomplete="off"  class="form-control td-field-group__field" id="floatingPassword" v-model="form.password"  >
            ...
            <div class="mb-2 form-floating td-field-group td-field-group--required">
                <input type="password" placeholder="Confirm Password" autocomplete="off"  class="form-control td-field-group__field" id="floatingConfirmPassword" v-model="form.confirmPassword"  >
...
export default {
  ...
  setup() {
        ...
        const {form , handleSubmit }  = useTDResetPassword();
