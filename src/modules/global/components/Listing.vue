...
import ListItem from "./ListingItem.vue" 
import ErrorMessage from "./ErrorMessage.vue.vue"
...
export default {
  ...
  methods: {
    getData: async function () {
      ...
      let res = await GlobalServices.Photos.getAlbumById(this.albumId);
      if(res.data)
